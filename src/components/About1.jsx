        ...
        <div className='bg-white mt-12 lg:mt-0 flex flex-col justify-center items-center h-full p-20 sm:p-0 lg:h-3/5 '>
            ...
            <div className='  flex lg:flex-row flex-col justify-center items-center lg:space-x-20 space-y-4'>
                ...
                <div className='  bg-gray-200 rounded-xl space-y-4 p-4 w-screen lg:w-2/5 flex flex-col justify-center items-center'>
                    ...
                    <div>I bring with me three months of hands-on experience in <em className='font-bold text-lg'> full-stack development at unicorniz innovation</em>, where I've honed my skills in crafting end-to-end solutions. My journey in the tech industry has been marked by a dedication to delivering seamless user experiences and pushing the boundaries of web development.</div>
                    <div>In addition to my full stack development prowess, I've delved into the exciting world of blockchain development. My knowledge in this domain includes a solid understanding of smart contracts, decentralized applications (DApps), and the underlying technologies that power the blockchain ecosystem.</div>
